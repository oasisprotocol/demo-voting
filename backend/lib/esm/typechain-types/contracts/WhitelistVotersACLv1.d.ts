...
export interface WhitelistVotersACLv1Interface extends utils.Interface {
    functions: {
        ...
        "listEligibleVoters(bytes32)": FunctionFragment;
        "onPollCreated(address,bytes32,address)": FunctionFragment;
        "setEligibleVoters(address,bytes32,address[])": FunctionFragment;
        "setPollManagers(address,bytes32,address[])": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "canCreatePoll" | "canManagePoll" | "canVoteOnPoll" | "listEligibleVoters" | "onPollCreated" | "setEligibleVoters" | "setPollManagers"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "listEligibleVoters", values: [PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "onPollCreated", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BytesLike>,
        PromiseOrValue<string>
    ]): string;
    encodeFunctionData(functionFragment: "setEligibleVoters", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BytesLike>,
        PromiseOrValue<string>[]
    ]): string;
    ...
    decodeFunctionResult(functionFragment: "listEligibleVoters", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "onPollCreated", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setEligibleVoters", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setPollManagers", data: BytesLike): Result;
    events: {};
}
export interface WhitelistVotersACLv1 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: WhitelistVotersACLv1Interface;
    ...
    functions: {
        ...
        listEligibleVoters(proposalId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[string[]]>;
        ...
        setEligibleVoters(dao: PromiseOrValue<string>, proposalId: PromiseOrValue<BytesLike>, voters: PromiseOrValue<string>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setEligibleVoters(dao: PromiseOrValue<string>, proposalId: PromiseOrValue<BytesLike>, voters: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        ...
        listEligibleVoters(proposalId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        onPollCreated(dao: PromiseOrValue<string>, proposalId: PromiseOrValue<BytesLike>, creator: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        setEligibleVoters(dao: PromiseOrValue<string>, proposalId: PromiseOrValue<BytesLike>, voters: PromiseOrValue<string>[], overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        listEligibleVoters(proposalId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        onPollCreated(dao: PromiseOrValue<string>, proposalId: PromiseOrValue<BytesLike>, creator: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
