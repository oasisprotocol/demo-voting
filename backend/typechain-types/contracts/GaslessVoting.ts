...
export interface GaslessVotingInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "CREATEPROPOSAL_TYPE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "CREATEPROPOSAL_TYPEHASH",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "VOTINGREQUEST_TYPE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "VOTINGREQUEST_TYPEHASH",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "addKeypair",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "listAddresses",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "makeProposalTransaction",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "makeVoteTransaction",
    values: [
      PromiseOrValue<BigNumberish>,
      VotingRequestStruct,
      SignatureRSVStruct
...
export interface GaslessVoting extends BaseContract {
  ...
  functions: {
    ...
    makeProposalTransaction(
      ...
      request: ProposalParamsStruct,
      rsv: SignatureRSVStruct,
      overrides?: CallOverrides
    ): Promise<[string]>;

    makeVoteTransaction(
      gasPrice: PromiseOrValue<BigNumberish>,
      request: VotingRequestStruct,
      rsv: SignatureRSVStruct,
      overrides?: CallOverrides
    ): Promise<[string] & { output: string }>;

    proxy(
      ciphertextNonce: PromiseOrValue<BytesLike>,
      data: PromiseOrValue<BytesLike>,
      overrides?: PayableOverrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    setDAO(
      in_dao: PromiseOrValue<string>,
